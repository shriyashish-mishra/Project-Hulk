...
/**
 * Dedicated landing-page palette — deliberately its own values rather
 * than the shared in-app theme tokens (bg-card/text-primary/etc.), since
 * this brief specifies an exact marketing palette distinct from the
 * dashboard's OKLCH-derived one. Centralized here once so every section
 * below stays in sync if the palette ever moves.
 */
const COLOR = {
  bg: "#000000",
  card: "#0A0A0A",
...
/** This landing page uses Inter specifically, distinct from the app's own Poppins (set on <html> in the root layout) — loaded and scoped here rather than globally, so it doesn't affect the rest of the app. */
...
const STEPS = [
  ...
  },
  {
    ...
    description: "One tap builds a prompt from everything logged today.",
  },
  {
    number: "03",
    icon: Copy,
    title: "Paste into your own Claude",
    description: "Your data only goes where you send it.",
  },
  {
    number: "04",
    icon: Sparkles,
    title: "Import your report",
    description: "Paste Claude's reply back in to get your scored coach report instantly.",
  },
] as const;
    ...
    <section className="px-5 py-6">
      ...
      >
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <h2 className="text-2xl font-bold" style={{ color: COLOR.textPrimary }}>
            Your data never leaves automatically.
          </h2>
          <p className="text-sm leading-6" style={{ color: COLOR.textSecondary }}>
            Project Hulk builds the prompt — you decide when and where to paste it. Nothing is sent to any AI
