...
const ALWAYS_ALLOWED_PATHS = [
  ...
  "/api/quick/",
  // Legal pages, and the marketing "story" page, need to be readable by a
  // prospective signup who has no session yet AND by an already-logged-in
  // user re-reading them — unlike PUBLIC_PATHS below, which bounces a
  // logged-in visitor away, these should never redirect either way.
  "/terms",
  "/privacy",
  "/story",
];
