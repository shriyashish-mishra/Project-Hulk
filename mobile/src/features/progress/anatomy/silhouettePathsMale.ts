 ...
 * geometry as the female asset (silhouettePaths.ts). Only the torso is
 * redrawn: broader shoulders and a reduced waist/hip taper. Ported
 * verbatim from the web app's silhouette-paths-male.ts.
 */
